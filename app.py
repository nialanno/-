...
if not st.session_state['accepted_terms']:
    ...
    if not st.session_state['selected_district']:
        ...
        if menu == "Главная":
            ...
            # Попытка автоматического определения геопозиции
            try:
                ...
                if location_data and location_data.get("latitude"):
                    ...
                    st.success(f"✅ Ваша геопозиция: Широта {user_lat:.5f}, Долгота {user_lon:.5f}")
                else:
                    st.info("🌐 Не удалось определить геопозицию автоматически. Кликните на карте, чтобы указать своё местоположение.")
            except ImportError:
                st.warning("⚠️ Библиотека `streamlit_geolocation` не установлена. Кликните на карте, чтобы указать своё местоположение.")
            ...
            if st.session_state['user_location']:
                ...
                st.info("ℹ️ Укажите своё местоположение (автоматически, по адресу или кликом на карте), чтобы найти ближайшее здание.")
                st.session_state['closest_building'] = None
